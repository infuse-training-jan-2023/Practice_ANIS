...
class Test_TestFrameWork < Test::Unit::TestCase
  ...
  def test_navigate_invalid_url
    create_testframe_instance = SeleniumFrameWork.new()
    url = "file:///src/abc"
    # url = "http://127.0.0.1:5500/Framework/abc.html"
  ...
  def test_close_driver
    create_testframe_instance = SeleniumFrameWork.new()
    assert_equal("Diver Closed", create_testframe_instance.close_site())
  end
  ...
  def test_click_button
    ...
    url = "file://src/Test_Framework.html"
    create_testframe_instance.open_site(url)
    create_testframe_instance.scoll_by(1)
  ...
  def test_send_keys
    ...
    create_testframe_instance.open_site(url)
    name = "Test"
    assert_equal("Text Sent", create_testframe_instance.send_text("id", "name", name))
    create_testframe_instance.close_site()
  end

  def test_send_invalid_keys
    create_testframe_instance = SeleniumFrameWork.new()
    url = "file://src/Test_Framework.html"
    create_testframe_instance.open_site(url)
    name = "Test"
  ...
  def test_send_keys
    ...
    assert_equal("Text Sent", create_testframe_instance.send_text("id", "email", email))
    create_testframe_instance.close_site()
  end
  ...
  def test_send_keys
    ...
    create_testframe_instance.open_site(url)
    pass = "1234567890"
    assert_equal("Text Sent", create_testframe_instance.send_text("id", "password", pass))
    create_testframe_instance.close_site()
  end
  ...
  def test_send_keys
    ...
    create_testframe_instance.open_site(url)
    dob = "01-01-1999"
    assert_equal("Text Sent", create_testframe_instance.send_text("id", "dob", dob))
    create_testframe_instance.close_site()
  end
  ...
  def test_send_keys
    ...
    create_testframe_instance.open_site(url)
    address = "Panjim Goa"
    assert_equal("Text Sent", create_testframe_instance.send_text("id", "address", address))
    create_testframe_instance.close_site()
  end
  ...
  def test_get_url
    ...
    url = "file://src/Test_Framework.html"
    create_testframe_instance.open_site(url)
    assert_equal("Test_Framework.html", create_testframe_instance.get_current_url())
    create_testframe_instance.close_site()
  end
